...
test('Identity', t => {
  ...
  const identity2 = Identity.getSharedInstance(testSettingsPath)
  t.strictEquals(Identity.instance, identity, 'there is only one copy of the identity singleton instance')
