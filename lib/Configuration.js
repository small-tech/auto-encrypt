...
class Configuration {
  ...
  DEFAULT_STAGING_PATH    = Configuration.defaultPathFor('staging')
  DEFAULT_PRODUCTION_PATH = Configuration.defaultPathFor('production')

  defaultPathFor (environmentName) {
