...
class Configuration {
  ...
  static initialise (settings) {
    ...
    Configuration._certificateMetadataPath = path.join(Configuration.certificateDirectoryPath, 'certificate.json')

    Configuration.initialised = true

    console.log(' ⚙ [Auto Encrypt] Configuration initialised.', Configuration)
  }
  ...
  static get certificateMetadataPath () {
    return Configuration.returnValueIfNotNull(Configuration._certificateMetadataPath)
  }
  ...
  static set certificateMetadataPath (state)  { throwReadOnlyError('certificateMetadataPath')  }
  ...
  static [util.inspect.custom] () {
    return `
      ...
      .certificateIdentityPath : Path to private key for certificate     ${Configuration.certificateIdentityPath}
      .certificateMetadataPath : Path to certificate metadata file       ${Configuration.certificateMetadataPath}` : `Not initialised. Use Configuration.initialise() method to initialise.`}
    `
  }
