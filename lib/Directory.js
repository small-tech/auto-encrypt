...
class Directory {
  ...
  static async getSharedInstance (configuration) {
  ...
  constructor(configuration) {
    ...
    log(` 📕 Directory is using the Let’s Encrypt ${this.staging ? 'staging' : 'PRODUCTION'} server.`)
  }
  ...
  [util.inspect.custom] () {
    return `
      # Directory (URLs for the Let’s Encrypt ${this.staging ? 'staging' : 'PRODUCTION'} endpoint)
