...
class Certificate {
  ...
  constructor (domains) {
    ...
    //
    // TODO: Check here if certificate-identity.pem.old or certificate.pem.old files exist.
    ...
    //       succeed or at least buy the adminstrator time to fix the issue.
    //
  ...
  async provisionCertificate () {
    ...
    //
    // TODO: Also get the certificate identity from the order object.
    //
  ...
  renewCertificate () {
    //
    // TODO: Backup the existing certificate and certificate identity (*.pem → *.pem.old). Then create a new
    ...
    //       If it’s not succesful, restore the old files.
    //
  }
